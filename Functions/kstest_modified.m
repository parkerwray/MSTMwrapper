function [H, pValue, KSstatistic, criticalValue] = kstest_modified(x, varargin)
...
switch tail
   case  0      %  2-sided test: T = max|S(x) - CDF(x)|.
      ...
      %deltaCDF    =  abs(sampleCDF(2:end)   - nullCDF);   % Vertical difference at jumps approaching from the RIGHT.
