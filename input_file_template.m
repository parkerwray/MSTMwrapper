% The purpose of this simulation is to determine how good of a template one can design.
...
% Results: this showed that we can make a pretty darn good template.