...
% particles where the particle radii are selected from a uniform
% distribution. 
...
% Results: The films were remarkably similar to those with delta
% distributions. Notably, coupling effects seemed to be weaker for radii
% near the ends of the distribution.