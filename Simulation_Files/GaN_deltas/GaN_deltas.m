% The purpose of this simulation was to make a point of comparison for more
% complex distributions. These had been previously studied to some extent.
...
% in an infinite loop.
fill_fractions = [0.1, 0.2, 0.3, 0.4];
...
% Results: This showed  similar results to those shown in the
% previous paper.