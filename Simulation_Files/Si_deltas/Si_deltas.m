% The purpose of this simulation is to look at distributions of Si
% particles where all particles are of the same radius. These have been
% previously studied, but it is useful as a point of comparison.
...
% Results: The films showed the expected (and previously documented)
% effects of reduced coupling, while still maintaining the overall Kerker
% shape.