...
%sca = 
clearvars I reflectances sca fbr_num fbr_denom fbr_net sca_net total_reflectances
I = squeeze((mean(Ipar,3)+mean(Iper,3))./2);
...
figure,
hold on
plot(wavelengths, 100*squeeze(total_reflectances(1, :)));
...
legend("True data", "Isolated data");
set(gca, 'FontSize', 24);
       box on
       pbaspect([1,1,1]);
       %ylim([0, 100]);