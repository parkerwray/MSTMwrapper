% The purpose of this simulation was to look at the behavior at higher 
% fill-fractions for GaN.
...
% in an infinite loop.
fill_fractions = [0.3, 0.4, 0.5, 0.6];
...
% Results: this showed that resonances were weaker at higher fill-fraction,
% but the overall shape was almost completely identical.