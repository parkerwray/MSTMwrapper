% The purpose of this simulation is to look at isolated GaN particles to
% cinform that all of the calculations match the analytical solutions.
...
center_radiis = [100, 110, 120, 130, 140, 150, 160, 170, 180];
...
% computing power. 
wavelengths = linspace(300,900,121);
...
% Results: GaN shows very similar behavior over a wide range--it is always
% forward-scattering, with a resonance at a particular size parameter. The
% strength of the resonance increases moderately with radius.